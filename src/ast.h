...
#define VM_AST_VARIADIC_CALL_SPEC_(func, suffix, ...) func##suffix

#define VM_AST_VARIADIC_CALL_SPEC(func, ...)                                   \
  VM_EXPAND_VA(VM_AST_VARIADIC_CALL_SPEC_(func, )(__VA_ARGS__))

// call spec with fixed args
#define VM_AST_CALL_SPEC_0(func) VM_AST_VARIADIC_CALL_SPEC(func)

#define VM_AST_CALL_SPEC_1(func, a) VM_AST_VARIADIC_CALL_SPEC(func, a)

#define VM_AST_CALL_SPEC_2(func, a, b) VM_AST_VARIADIC_CALL_SPEC(func, a, b)
