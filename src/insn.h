...
typedef enum vm_insn {
  ...
  VM_INSN_ADDB_IMM8_R0_TO_R0 = 0x50,
  VM_INSN_ADDB_IMM8_R0_TO_R1,
  VM_INSN_ADDB_IMM8_R0_TO_R2,
  VM_INSN_ADDB_IMM8_R0_TO_R3,

  VM_INSN_SUBB_IMM8_R0_TO_R0,
  VM_INSN_SUBB_IMM8_R0_TO_R1,
  VM_INSN_SUBB_IMM8_R0_TO_R2,
  VM_INSN_SUBB_IMM8_R0_TO_R3,

  VM_INSN_MULB_IMM8_R0_TO_R0,
  VM_INSN_MULB_IMM8_R0_TO_R1,
  VM_INSN_MULB_IMM8_R0_TO_R2,
  VM_INSN_MULB_IMM8_R0_TO_R3,

  VM_INSN_DIVB_IMM8_R0_TO_R0,
  VM_INSN_DIVB_IMM8_R0_TO_R1,
  VM_INSN_DIVB_IMM8_R0_TO_R2,
  VM_INSN_DIVB_IMM8_R0_TO_R3,

  VM_INSN_ADDB_IMM8_R1_TO_R0 = 0x60,
  VM_INSN_ADDB_IMM8_R1_TO_R1,
  VM_INSN_ADDB_IMM8_R1_TO_R2,
  VM_INSN_ADDB_IMM8_R1_TO_R3,

  VM_INSN_SUBB_IMM8_R1_TO_R0,
  VM_INSN_SUBB_IMM8_R1_TO_R1,
  VM_INSN_SUBB_IMM8_R1_TO_R2,
  VM_INSN_SUBB_IMM8_R1_TO_R3,

  VM_INSN_MULB_IMM8_R1_TO_R0,
  VM_INSN_MULB_IMM8_R1_TO_R1,
  VM_INSN_MULB_IMM8_R1_TO_R2,
  VM_INSN_MULB_IMM8_R1_TO_R3,

  VM_INSN_DIVB_IMM8_R1_TO_R0,
  VM_INSN_DIVB_IMM8_R1_TO_R1,
  VM_INSN_DIVB_IMM8_R1_TO_R2,
  VM_INSN_DIVB_IMM8_R1_TO_R3,

  VM_INSN_ADDB_IMM8_R2_TO_R0 = 0x70,
  VM_INSN_ADDB_IMM8_R2_TO_R1,
  VM_INSN_ADDB_IMM8_R2_TO_R2,
  VM_INSN_ADDB_IMM8_R2_TO_R3,

  VM_INSN_SUBB_IMM8_R2_TO_R0,
  VM_INSN_SUBB_IMM8_R2_TO_R1,
  VM_INSN_SUBB_IMM8_R2_TO_R2,
  VM_INSN_SUBB_IMM8_R2_TO_R3,

  VM_INSN_MULB_IMM8_R2_TO_R0,
  VM_INSN_MULB_IMM8_R2_TO_R1,
  VM_INSN_MULB_IMM8_R2_TO_R2,
  VM_INSN_MULB_IMM8_R2_TO_R3,

  VM_INSN_DIVB_IMM8_R2_TO_R0,
  VM_INSN_DIVB_IMM8_R2_TO_R1,
  VM_INSN_DIVB_IMM8_R2_TO_R2,
  VM_INSN_DIVB_IMM8_R2_TO_R3,

  VM_INSN_ADDB_IMM8_R3_TO_R0 = 0x80,
  VM_INSN_ADDB_IMM8_R3_TO_R1,
  VM_INSN_ADDB_IMM8_R3_TO_R2,
  VM_INSN_ADDB_IMM8_R3_TO_R3,
