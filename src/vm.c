...
static void vm_subb_imm8_r2_to_regs(vm_t *vm) {
  switch (vm->buf[vm->ip]) {
  case VM_INSN_SUBB_IMM8_R2_TO_R0:
    vm_insn_subb_imm8_r2_to_r0(vm);
    break;
  case VM_INSN_SUBB_IMM8_R2_TO_R1:
    vm_insn_subb_imm8_r2_to_r1(vm);
    break;
  case VM_INSN_SUBB_IMM8_R2_TO_R2:
    vm_insn_subb_imm8_r2_to_r2(vm);
    break;
  case VM_INSN_SUBB_IMM8_R2_TO_R3:
    vm_insn_subb_imm8_r2_to_r3(vm);
    break;
  }
}
...
static void vm_divb_imm8_r2_to_regs(vm_t *vm) {
  switch (vm->buf[vm->ip]) {
  case VM_INSN_DIVB_IMM8_R2_TO_R0:
    vm_insn_divb_imm8_r2_to_r0(vm);
    break;
  case VM_INSN_DIVB_IMM8_R2_TO_R1:
    vm_insn_divb_imm8_r2_to_r1(vm);
    break;
  case VM_INSN_DIVB_IMM8_R2_TO_R2:
    vm_insn_divb_imm8_r2_to_r2(vm);
    break;
  case VM_INSN_DIVB_IMM8_R2_TO_R3:
    vm_insn_divb_imm8_r2_to_r3(vm);
    break;
  }
}
...
void vm_run(vm_t *vm) {
  while (vm->buf[++vm->ip] && !vm->is_error) {
    ...
    case VM_INSN_ADDB_IMM8_R2_TO_R3:
      ...
      break;
    // subtract imm8, r2 and store its result to
    // general-purpose register.
    case VM_INSN_SUBB_IMM8_R2_TO_R0:
    case VM_INSN_SUBB_IMM8_R2_TO_R1:
    case VM_INSN_SUBB_IMM8_R2_TO_R2:
    ...
    case VM_INSN_MULB_IMM8_R2_TO_R3:
      ...
      break;
    // divide imm8, r2 and store its result to
    // general-purpose register.
    case VM_INSN_DIVB_IMM8_R2_TO_R0:
    case VM_INSN_DIVB_IMM8_R2_TO_R1:
    case VM_INSN_DIVB_IMM8_R2_TO_R2:
