...
static void vm_ast_process_ternary_addb_imm8_regs_instruction(
  ...
  if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]), "r0") &&
    ...
    visitor(file, VM_INSN_ADDB_IMM8_R1_TO_R0);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r1") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r1")) {
    visitor(file, VM_INSN_ADDB_IMM8_R1_TO_R1);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r2") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r1")) {
    visitor(file, VM_INSN_ADDB_IMM8_R1_TO_R2);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r3") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r1")) {
    visitor(file, VM_INSN_ADDB_IMM8_R1_TO_R3);
  }

  if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]), "r0") &&
      !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]), "r2")) {
    visitor(file, VM_INSN_ADDB_IMM8_R2_TO_R0);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r1") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r2")) {
    visitor(file, VM_INSN_ADDB_IMM8_R2_TO_R1);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r2") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r2")) {
    visitor(file, VM_INSN_ADDB_IMM8_R2_TO_R2);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r3") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r2")) {
    visitor(file, VM_INSN_ADDB_IMM8_R2_TO_R3);
  }

  if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]), "r0") &&
      !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]), "r3")) {
    visitor(file, VM_INSN_ADDB_IMM8_R3_TO_R0);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r1") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r3")) {
    visitor(file, VM_INSN_ADDB_IMM8_R3_TO_R1);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r2") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r3")) {
    visitor(file, VM_INSN_ADDB_IMM8_R3_TO_R1);
             ...
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r3")) {
    visitor(file, VM_INSN_ADDB_IMM8_R3_TO_R3);
  }
...
static void vm_ast_process_ternary_subb_imm8_regs_instruction(
  ...
  if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]), "r0") &&
      !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]), "r1")) {
    visitor(file, VM_INSN_SUBB_IMM8_R1_TO_R0);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r1") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r1")) {
    visitor(file, VM_INSN_SUBB_IMM8_R1_TO_R1);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r2") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r1")) {
    visitor(file, VM_INSN_SUBB_IMM8_R1_TO_R2);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r3") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r1")) {
    visitor(file, VM_INSN_SUBB_IMM8_R1_TO_R3);
  }

  if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]), "r0") &&
      !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]), "r2")) {
    visitor(file, VM_INSN_SUBB_IMM8_R2_TO_R0);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r1") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r2")) {
    visitor(file, VM_INSN_SUBB_IMM8_R2_TO_R1);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r2") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r2")) {
    visitor(file, VM_INSN_SUBB_IMM8_R2_TO_R2);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r3") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r2")) {
    visitor(file, VM_INSN_SUBB_IMM8_R2_TO_R3);
  }
...
static void vm_ast_process_ternary_mulb_imm8_regs_instruction(
  ...
  if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]), "r0") &&
      !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]), "r1")) {
    visitor(file, VM_INSN_MULB_IMM8_R1_TO_R0);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r1") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r1")) {
    visitor(file, VM_INSN_MULB_IMM8_R1_TO_R1);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r2") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r1")) {
    visitor(file, VM_INSN_MULB_IMM8_R1_TO_R2);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r3") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r1")) {
    visitor(file, VM_INSN_MULB_IMM8_R1_TO_R3);
  }

  if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]), "r0") &&
      !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]), "r2")) {
    visitor(file, VM_INSN_MULB_IMM8_R2_TO_R0);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r1") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r2")) {
    visitor(file, VM_INSN_MULB_IMM8_R2_TO_R1);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r2") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r2")) {
    visitor(file, VM_INSN_MULB_IMM8_R2_TO_R2);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r3") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r2")) {
    visitor(file, VM_INSN_MULB_IMM8_R2_TO_R3);
  }
...
static void vm_ast_process_ternary_divb_imm8_regs_instruction(
    vm_ast_t *ast, FILE *file, void (*visitor)(FILE *file, int opcode)) {
  if (VM_AST_GET_NUM_CHILDS(ast) != 4) {
    return;
  }
  ...
  if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]), "r0") &&
      !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]), "r0")) {
    visitor(file, VM_INSN_DIVB_IMM8_R0_TO_R0);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r1") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r0")) {
    visitor(file, VM_INSN_DIVB_IMM8_R0_TO_R1);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r2") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r0")) {
    visitor(file, VM_INSN_DIVB_IMM8_R0_TO_R2);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r3") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r0")) {
  ...
  if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]), "r0") &&
      !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]), "r2")) {
    visitor(file, VM_INSN_DIVB_IMM8_R2_TO_R0);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r1") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r2")) {
    visitor(file, VM_INSN_DIVB_IMM8_R2_TO_R1);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r2") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r2")) {
    visitor(file, VM_INSN_DIVB_IMM8_R2_TO_R2);
  } else if (!strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[1]),
                         "r3") &&
             !strcasecmp((const char *)VM_AST_GET_REGS_NAME(ast->childs[3]),
                         "r2")) {
    visitor(file, VM_INSN_DIVB_IMM8_R2_TO_R3);
  }
...
static void vm_ast_process_instruction_line(vm_ast_t *ast, FILE *file,
  ...
  if (!strcasecmp((char *)ast->childs[0]->mnemonic.name, "addb") &&
    ...
    vm_ast_process_ternary_mulb_imm8_regs_instruction(ast, file, visitor);
             ...
             ast->childs[2]->kind_type == VM_AST_INTEGER_VALUE &&
             ast->childs[3]->kind_type == VM_AST_REGISTER) {
    vm_ast_process_ternary_divb_imm8_regs_instruction(ast, file, visitor);
  }
