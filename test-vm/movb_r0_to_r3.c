...
static unsigned char test0[] = {VM_INSN_MOVB_IMM8_TO_R0, 0xfa, 0x0a,
                                VM_INSN_MOVB_R0_TO_R3, 0x00};

static unsigned char test1[] = {VM_INSN_MOVB_IMM8_TO_R0, 0xff, 0x0a,
                                VM_INSN_MOVB_R0_TO_R3, 0x00};

static void test_movb_r0_to_r3__micro_test0(void) {
...
static void test_movb_r0_to_r3__micro_test1(void) {
...
void test_movb_r0_to_r3(void) {
  test_movb_r0_to_r3__micro_test0();
  test_movb_r0_to_r3__micro_test1();
}
